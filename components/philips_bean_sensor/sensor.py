...
philips_bean_sensor_ns = cg.esphome_ns.namespace(
    'philips_series_2200').namespace('philips_bean_sensor')
BeanSensor = philips_bean_sensor_ns.class_(
    'BeanSensor', sensor.Sensor, cg.Component)

Source = philips_bean_sensor_ns.enum("Source")
SOURCES = {
...
CONFIG_SCHEMA = sensor.SENSOR_SCHEMA.extend({
    cv.GenerateID(): cv.declare_id(BeanSensor),
...
async def to_code(config):
    ...
    cg.add(parent.add_bean_sensor(var))
